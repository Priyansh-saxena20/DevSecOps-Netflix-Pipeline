pipeline{
    ...
    stages {
        ...
        stage('Deploy to container'){
            steps{
                sh 'docker run -d -p 8081:80 priiyansh/netflix:latest'
            }
        }

        #Kubernetes stage:- This stage will deploy our yml file in kubernetes cluster inside EKS "
    ...
    post {                  #post job stage this stage will mail to me(priyansh)for evry build,fail in the pipeline
     always {
